...
void inserirInicio(struct lista* list, int element){
	...
	if(novo){
		...
		printf("Alocaçăo dinâmica falhou!\n");
	}
}
...
void removerInicio(struct lista* list){
	...
	if(aux){
		...
		printf("Năo é possível remover elementos de uma lista vazia!\n");
	}	
}
...
void exibirLista(struct lista list){
	...
	if(aux){
		...
		printf("Năo é possível exibir os elementos de uma lista vazia!\n");
	}
}
